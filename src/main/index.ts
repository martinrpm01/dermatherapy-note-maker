...
function registerIpc() {
  ...
  ipcMain.handle("documents:generateConsultQuestionnaire", (_, recordId: string, input) =>
  ...
  ipcMain.handle("documents:generateCompletedLesionForm", (_, recordId: string, options) =>
    service.generateDocumentOnlyCompletedLesionForm(recordId, options)
  );
  ...
  ipcMain.handle("course:generateConsultQuestionnaire", (_, courseId: string, input) =>
  ...
  ipcMain.handle("course:generateCompletedLesionForm", (_, courseId: string, options) =>
    service.generateCourseCompletedLesionForm(courseId, options)
  );
